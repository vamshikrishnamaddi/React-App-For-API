Liferay.Loader.define('my-react-app$graceful-fs@4.2.10/graceful-fs', ['module', 'exports', 'require', 'my-react-app$fs', './polyfills', './legacy-streams', './clone', 'my-react-app$util', 'my-react-app$assert'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    if (!fs[gracefulQueue]) {
      ...
      if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || '')) {
        process.on('exit', function () {
          ...
          require('my-react-app$assert').equal(fs[gracefulQueue].length, 0);
        });
      }
    }
    ...
    function patch(fs) {
      ...
      if (fs$appendFile) fs.appendFile = function appendFile(path, data, options, cb) {
        if (typeof options === 'function') cb = options, options = null;
      ...
      if (fs$copyFile) fs.copyFile = function copyFile(src, dest, flags, cb) {
