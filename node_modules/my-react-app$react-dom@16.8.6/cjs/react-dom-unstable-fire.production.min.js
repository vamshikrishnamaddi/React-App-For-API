...
*/
'use strict';
Liferay.Loader.define("my-react-app$react-dom@16.8.6/cjs/react-dom-unstable-fire.production.min", ['module', 'exports', 'require', 'my-react-app$react', 'my-react-app$object-assign', 'my-react-app$scheduler'], function (module, exports, require) {
  var define = undefined;
  var global = window;
  {
    var aa = require("my-react-app$react"),
        n = require("my-react-app$object-assign"),
        r = require("my-react-app$scheduler");function ba(a, b, c, d, e, f, g, h) {
      if (!a) {
