Liferay.Loader.define("my-react-app$email-addresses@5.0.0/test/is_email", ['module', 'exports', 'require', 'my-react-app$fs', 'my-react-app$libxmljs', 'my-react-app$tap', '../lib/email-addresses'], function (module, exports, require) {
    var define = undefined;
    var global = window;
    {
        var fs = require("my-react-app$fs"),
            libxmljs = require("my-react-app$libxmljs"),
            test = require("my-react-app$tap").test;
