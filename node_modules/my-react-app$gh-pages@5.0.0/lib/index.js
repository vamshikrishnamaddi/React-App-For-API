Liferay.Loader.define('my-react-app$gh-pages@5.0.0/lib/index', ['module', 'exports', 'require', 'my-react-app$find-cache-dir', './git', 'my-react-app$filenamify', './util', 'my-react-app$fs-extra', 'my-react-app$globby', 'my-react-app$path', 'my-react-app$util'], function (module, exports, require) {
  var define = undefined;
  var global = window;
  {
    const findCacheDir = require('my-react-app$find-cache-dir');
    const Git = require('./git');
    const filenamify = require('my-react-app$filenamify');
    const copy = require('./util').copy;
    const getUser = require('./util').getUser;
    const fs = require('my-react-app$fs-extra');
    const globby = require('my-react-app$globby');
    const path = require('my-react-app$path');
    const util = require('my-react-app$util');
