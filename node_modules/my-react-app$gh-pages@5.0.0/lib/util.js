Liferay.Loader.define('my-react-app$gh-pages@5.0.0/lib/util', ['module', 'exports', 'require', 'my-react-app$path', './git', 'my-react-app$async', 'my-react-app$fs-extra'], function (module, exports, require) {
  var define = undefined;
  var global = window;
  {
    const path = require('my-react-app$path');
    const Git = require('./git');
    const async = require('my-react-app$async');
