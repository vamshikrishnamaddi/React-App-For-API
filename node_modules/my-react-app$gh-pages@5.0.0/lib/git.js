Liferay.Loader.define('my-react-app$gh-pages@5.0.0/lib/git', ['module', 'exports', 'require', 'my-react-app$child_process', 'my-react-app$fs-extra', 'my-react-app$path', 'my-react-app$util'], function (module, exports, require) {
  var define = undefined;
  var global = window;
  {
    const cp = require('my-react-app$child_process');
    ...
    Git.prototype.checkout = function (remote, branch) {
      return this.exec('ls-remote', '--exit-code', '.', remote + '/' + branch).then(() => {
