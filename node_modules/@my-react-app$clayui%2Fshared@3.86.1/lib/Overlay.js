...
Liferay.Loader.define("@my-react-app$clayui/shared@3.86.1/lib/Overlay", ['module', 'exports', 'require', 'my-react-app$aria-hidden', 'my-react-app$react', './Keys', './Portal', './useInteractOutside'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    function Overlay(_ref) {
      ...
      }, [onClose]), isOpen, true, [isOpen, onClose]);
      useEvent('keydown', (0, _react.useCallback)(function (event) {
        if (event.key === _Keys.Keys.Esc) {
