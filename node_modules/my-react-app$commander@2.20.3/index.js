Liferay.Loader.define('my-react-app$commander@2.20.3/index', ['module', 'exports', 'require', 'my-react-app$events', 'my-react-app$child_process', 'my-react-app$path', 'my-react-app$fs', 'my-react-app$util'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    var EventEmitter = require('my-react-app$events').EventEmitter;
    var spawn = require('my-react-app$child_process').spawn;
    ...
    require('my-react-app$util').inherits(Command, EventEmitter);
