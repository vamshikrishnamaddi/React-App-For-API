...
declare type DisplayType = null | 'primary' | 'secondary' | 'light';
declare type Shape = null | 'circle' | 'squares';
declare type Size = null | 'xs' | 'sm' | 'md' | 'lg';
...
declare const ClayLoadingIndicator: React.ForwardRefExoticComponent<IProps & React.RefAttributes<HTMLSpanElement>>;
